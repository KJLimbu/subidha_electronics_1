    ...
    <>
            ...
            <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent z-10">
                ...
                <div className="p-12 bg-white mx-auto rounded-3xl w-115 shadow-xl">
                    ...
                    {/* Sign In Button */}
                    <div>
                        <button type="submit" className="w-full flex justify-center btn btn-primary text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-500">
                        Sign in
                        </button>
                    </div>
